            ...
            <div className="space-y-3">
              <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-emerald-500/20 space-y-2">
                <div className="flex items-center gap-2 text-emerald-300 font-bold text-xs">
                  ...
                  <span>Academic Question Bank Architecture (V2.7)</span>
                </div>
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>Download Official Android APK (v2.7)</span>
                  </div>
                  <span className="text-[10px] font-mono bg-emerald-400/20 px-2 py-0.5 rounded-full">Code 10</span>
                </button>
