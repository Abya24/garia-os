...
export const QuickSearchModal: React.FC<QuickSearchModalProps> = ({
  ...
  const searchableItems: SearchItem[] = [
    ...
    },
    {
      ...
      category: "Academics",
      description: "Class 10, 11 & 12 syllabus, NCERT chapters, VVI topics & roadmap",
      icon: GraduationCap,
      tags: ["academic", "syllabus", "ncert", "chapters", "physics", "chemistry", "math", "biology", "science", "commerce", "arts", "class 10", "class 11", "class 12"],
    },
    {
      id: "nav-qbank",
      tab: "questionbank",
      title: "Academic Question Bank",
      category: "Question Bank",
      description: "Topic-wise MCQs, PYQs, Timed Quizzes, Flashcards & Practice",
      icon: HelpCircle,
      tags: ["question", "bank", "mcq", "pyq", "quiz", "test", "flashcard", "practice", "vvi", "exam question", "previous year"],
    },
    {
      id: "nav-abya",
      tab: "abya",
