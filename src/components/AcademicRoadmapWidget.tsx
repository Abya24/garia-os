...
export const AcademicRoadmapWidget: React.FC<AcademicRoadmapWidgetProps> = ({
  ...
  return (
    <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 backdrop-blur-md shadow-xl text-white">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="font-semibold text-slate-100 text-base">Academic Roadmap</h3>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/30 text-xs font-medium transition-all"
        >
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center text-xs mb-1.5">
          ...
          <span className="text-purple-400 font-semibold">{roadmap.overallProgress}% Completed</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2.5 mb-4">
        <div className="p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/50 flex flex-col items-center text-center">
          <span className="text-xs text-slate-400 mb-0.5">Today Revisions</span>
          <div className="flex items-center gap-1 text-sm font-bold text-amber-400">
            <BookOpen className="w-3.5 h-3.5" /> {todayCount}
          </div>
        </div>
        ...
        <div className="p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/50 flex flex-col items-center text-center">
          <span className="text-xs text-slate-400 mb-0.5">Top VVI</span>
          <div className="flex items-center gap-1 text-sm font-bold text-rose-400 truncate max-w-full">
      ...
      {/* Next Recommended Action */}
      <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20 text-xs text-purple-200 flex items-center justify-between gap-2">
        ...
        <button
          onClick={() => onNavigate("academic")}
          className="text-purple-300 hover:text-white underline font-medium text-xs whitespace-nowrap"
        >
          Action
        </button>
      </div>
