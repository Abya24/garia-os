...
export const StatisticsPage: React.FC<StatisticsPageProps> = ({
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold font-heading text-white tracking-tight flex items-center gap-2">
            ...
            <span>Advanced Analytics & Score</span>
          </h1>
          <p className="text-slate-400 text-sm mt-1">
            Real-time productivity trends across study sessions, tasks, focus, and habits.
          </p>
        </div>

        {/* Timeframe Filter Tabs */}
        <div className="flex items-center gap-1 glass-card p-1.5 rounded-2xl border border-white/10 self-start sm:self-auto">
          <button
      ...
      {/* Study Hours Distribution Chart */}
      <div className="glass-card p-6 rounded-3xl border border-white/10 space-y-4">
        ...
        {subjects.length === 0 ? (
          ...
          <div className="space-y-4">
            {subjects.map((subj) => {
              // Calculate study seconds for this subject in current timeframe
